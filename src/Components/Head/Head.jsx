      ...
      <Header>
        ...
        <HeaderContent>
          <Heading>
            ...
            <ParagraphWrapper>
              <p>
                Hi, its nice to meet you. I am a full stack developer from vijayapur karnataka india
              </p>
            </ParagraphWrapper>
            <ActionsDiv>
              <a href="#projects">
          ...
          <Profile>
            <img src="https://i.imgur.com/oqEi4mE.jpg" alt="profile"  height={"300px"} width={"300px"}></img>
          </Profile>
        </HeaderContent>
        <Scroller>
